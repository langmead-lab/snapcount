...
sb <- set_row_filters(sb, SMTS == "Brain")
...
GNB1r <- set_coordinate_modifier(GNB1r, Coordinate$StartIsExactOrWithin)

###PIK3CD
PIK3CDl <- QueryBuilder(compilation = "gtex", regions = "chr1:9664595-9664595")
PIK3CDl <- set_row_filters(PIK3CDl, strand == "+")
PIK3CDl <- set_coordinate_modifier(PIK3CDl, Coordinates$EndIsExactOrWithin)

PIK3CDr <- QueryBuilder(compilation = "gtex", regions = "chr1:9664759-9664759")
PIK3CDr <- set_row_filters(PIK3CDr, strand == "+")
PIK3CDr <- set_coordinate_modifier(PIK3CDr, Coordinates$StartIsExactOrWithin)

###TAP2
TAP2l <- QueryBuilder(compilation = "gtex", regions = "chr6:32831148-32831148")
TAP2l <- set_row_filters(TAP2l, strand == "-")
TAP2l <- set_coordinate_modifier(TAP2l, Coordinates$EndIsExactOrWithin)

TAP2r <- QueryBuilder(compilation = "gtex", regions = "chr6:32831182-32831182")
TAP2r <- set_row_filters(TAP2r, strand == "-")
TAP2r <- set_coordinate_modifier(TAP2r, Coordinates$StartIsExactOrWithin)
...
```{r 'ts1', eval = TRUE}
setA <- QueryBuilder(compilation = "gtex", regions = "chr4:20763023-20763023")
setA <- set_row_filters(setA, strand == "-")
setA <- set_coordinate_modifier(setA, Coordinates$EndIsExactOrWithin)
...
setB <- QueryBuilder(compilation = "gtex", regions = "chr4:20763098-20763098")
setB <- set_row_filters(setB, strand == "-")
setB <- set_coordinate_modifier(setB, Coordinates$StartIsExactOrWithin)
